...
// import HeroCardBG from "assets/image/hero-card-background.png";
...
// import testHeroImage from "assets/image/hero_1_0.png";
// import skilltest from "assets/css/hero-skill1.png";
    ...
    <div
      onClick={() =>
        props.training !== null
          ...
          : props.gens === -1
          ? null
          : history.push(`hero/${props.networkId}/${props.heroId}`)
      }
    ...
    >
      ...
      {props.gens === -1 ? null : (
        <span className="new-hero-card-price">
          {props.stake_amount != null
            ? props.stake_amount > 999
              ? props.stake_amount.toLocaleString()
              : props.stake_amount
            : props.price > 999
